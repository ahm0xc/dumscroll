              ...
              <div className="swiper proofSlides pb-6">
                <div className="swiper-wrapper">
                  <div className="swiper-slide px-6 pb-12 pt-2">
                    <div className="relative rounded-[--card-border-radius] border-[length:var(--border-width)] border-[--ui-light-border-color] bg-white p-[--card-padding] shadow-xl shadow-gray-950/5 [--anchor:100] [--border-radius:calc(var(--radius)*1px)] [--border-width:calc(var(--border)*1px)] [--border:1] [--glow:60] [--hue:179] [--lightness:55%] [--opacity:1] [--radius:24] [--saturation:78%] [--speed:2] dark:border-[--ui-dark-border-color] dark:bg-[--card-dark-bg] dark:[--lightness:14%] dark:[--saturation:97%]">
                      <div>
                        <svg
                        ...
                        <p className="mt-6 text-center text-lg text-gray-950 dark:text-white">
                      ...
                      <span className="glow absolute inset-[calc(var(--border-width)*-1)] rounded-[--card-border-radius] border-[length:var(--border-width)] border-transparent ![mask-clip:padding-box,_border-box] ![mask-composite:intersect] [mask:linear-gradient(transparent,transparent),linear-gradient(white,white)]">
                        <span className="absolute inline-block aspect-square h-20 bg-[radial-gradient(circle_at_right,hsl(0_0%_100%/0),transparent_50%),radial-gradient(circle_at_right,hsl(var(--hue)_var(--saturation)_var(--lightness,50%)/1)_50%,transparent)] opacity-[var(--opacity)] [animation:loop_5s_infinite_linear] [offset-anchor:calc(var(--anchor)*1%)_50%] [offset-path:rect(0_100%_100%_0_round_calc(var(--glow)*1px))] dark:bg-[radial-gradient(circle_at_right,hsl(0_0%_100%/0.75),transparent_50%),radial-gradient(circle_at_right,hsl(var(--hue)_var(--saturation)_var(--lightness,50%)/1)_50%,transparent)]" />
                      </span>
                    </div>
                  </div>
                  <div className="swiper-slide px-6 pb-12 pt-2">
                    <div className="relative rounded-[--card-border-radius] border-[length:var(--border-width)] border-[--ui-light-border-color] bg-white p-[--card-padding] shadow-xl shadow-gray-950/5 [--anchor:100] [--border-radius:calc(var(--radius)*1px)] [--border-width:calc(var(--border)*1px)] [--border:1] [--glow:60] [--hue:295] [--lightness:63%] [--opacity:1] [--radius:24] [--saturation:100%] [--speed:2] dark:border-[--ui-dark-border-color] dark:bg-[--card-dark-bg]">
                      <div>
                        <svg
                          className="mx-auto h-12 w-fit text-black dark:text-white"
                          xmlns="http://www.w3.org/2000/svg"
                          width={460}
                          height={160}
                          viewBox="0 0 460 160"
                      ...
                      <div>
                        <div className="mx-auto h-12 w-fit">
                          <svg
                            ...
                            style={
                              {
                                enableBackground: "new 0 0 251.8 48",
                ...
                <div className="swiper-pagination -mb-3 *:!h-0.5 *:!w-14 *:!rounded-lg" />
              </div>
            </div>
          </div>
        </div>
